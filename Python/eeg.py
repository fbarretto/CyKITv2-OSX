...
class EEG(object):
    ...
    def Setup(self, model, config):
        ...
        for d in hid.enumerate():
            ...
            #if "info" in config:
            print(type(device))
            print ( "Product name " + device.product_string)
            ...
            for i, findDevice in enumerate(deviceList):
                ...
                if device.product_string == deviceList[i]:
                    ...
                    if useDevice.upper() == "Y":
                        ...
                        print ( "> Using Device: " + device.product_string + "\r\n")
        ...
        self.myIOinstance.setInfo("Device", device.product_string)
    ...
    def run(self, key, myio):
        ...
        if self.myIOinstance.status == True:
            myio.sendData(1, "CyKITv2:::Info:::Device:::" + str(self.hid.product_string))
